...
tracers07,centers07,extra07 = model07.build_voids({
    "run_work_dir": model07.workdir / "tmplxhn4wcw2024-08-22T01:08:51.465883+00:00",
    "box": dbox.box})
voids07 = core.Voids(
    method='svf_popcorn',
    box = dbox.box,
...
plot07 = core.VoidPlotter(
    voids=voids07
)
vsf_kws={'delta':-0.7,'n_neighbors':600,'n_step1':1,'n_step2':3,'scale_1_num_samples':8,'scale_2_num_samples':1}
...
tracers07,centers07,extra07  = model_07.build_voids({
    "run_work_dir": model_07.workdir / "tmplxhn4wcw2024-08-22T01:08:51.465883+00:00",
    "box": dbox.box})

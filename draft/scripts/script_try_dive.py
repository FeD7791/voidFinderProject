...
# Get Box
box = io.read_table(dataset_path/"halos_ascii_1000_1024_npmin_10_z0.51.dat",names=["m","x", "y", "z", "vx", "vy", "vz"])


workdir = pathlib.Path("/home/jorgefederico/updates/vftk_1109/voidFinderProject/runz")
...
def build_zobov_model(workdir,*,delta=0.2):
    ...
    'run_work_dir':model.workdir / "tmpuo2jislx2024-09-18T23:23:15.845781+00:00",
    'box':box}
...
def build_dive_model(box,workdir,*,threshold=0.2,op_crit=False,ratio=1.5):
    ...
    model_find_parameters = {
    'run_work_dir':dive_model.workdir / "tmpuo2jislx2024-09-18T23:23:15.845781+00:00",   #"tmpv4suzrwr2024-09-16T00:16:06.078226+00:00",
    'box':box}

...
workdir_path = pathlib.Path(os.path.abspath("/home/jorgefederico/updates/vftk_actual002/voidFinderProject/runv"))
run_workdir_path = workdir_path / "tmpaizyo2s62024-09-07T21:10:14.262424+00:00" #0.8
run_workdir_path = workdir_path / "tmpaizyo2s62024-09-07T21:10:14.262424+00:00" #0.9
...
df = pd.read_csv(run_workdir_path / "output_txt.dat",delim_whitespace=True, header=1)
